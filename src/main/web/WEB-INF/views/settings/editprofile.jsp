...
<html>
<head>
    <title>Edit Profile :: DigiX</title>
    ...
    <div class="drop-navigation drop-navigation">
        <ul class="nav nav-sidebar">
            ...
            <ul class="cl-effect-2">
                <li class="active"><a href="${editInfoURL}"><span class="glyphicon glyphicon-edit"
                                                                  aria-hidden="true"></span>Edit Info</a></li>
...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="main-grids">
        <h4 class="contentTitle">Edit Profile</h4>
        ...
        <div class="edit">
            <form:form cssClass="row" action="/settings/editprofile" method="post" modelAttribute="userProfile">
                <input type="hidden" name="userID" value="${user.userID}">

                <ul class="collapsible popout white-text" data-collapsible="accordion">
                    <li>
                        <div class="collapsible-header grey darken-4 active"><i class="material-icons">person_pin</i>First name</div>
                        <div class="collapsible-body"><p><form:input path="firstName"
                                                                     placeholder="${user.firstName}"
                                                                     value="${user.firstName}"/></p></div>
                    </li>
                    <li>
                        <div class="collapsible-header grey darken-4"><i class="material-icons">perm_identity</i>Last name</div>
                        <div class="collapsible-body"><p><form:input path="lastName"
                                                                     placeholder="${user.lastName}"
                                                                     value="${user.lastName}"/></p></div>
                    </li>
                    <li>
                        <div class="collapsible-header grey darken-4"><i class="material-icons">email</i>Email</div>
                        <div class="collapsible-body"><p><form:input path="email"
                                                                     placeholder="${user.email}"
                                                                     value="${user.email}"/></p></div>
                    </li>
                    <li>
                        <div class="collapsible-header grey darken-4"><i class="material-icons">place</i>Location</div>
                        <div class="collapsible-body row"><p><form:input path="location"
                                                                         placeholder="${user.location}"
                                                                         value="${user.location}" cssClass=""/></p></div>
                    </li>
                </ul>
