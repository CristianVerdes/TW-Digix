...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="main-grids">
        ...
        <h4 class="contentTitle">Google Photos</h4>

        <c:forEach items="${photos}" var="photo">

            <div>
                <a href="${photo.path}"><img class="photo" src="${photo.path}}" alt="Preview"/></a>
                <form:form id="photosForm${photo.providerID}" cssClass="button photosForm" action="/settings/contentsync/google/photos/store" method="post">
                    <input type="hidden" name="providerID" value="${photo.providerID}"/>
                    <input type="hidden" name="url" value="${photo.path}"/>
    ...
    jQuery(document).ready(function ($) {
        $(function () {
            $('.photosForm').on('submit', function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: '/settings/contentsync/google/photos/store',
                    data: $(this).serialize(),
