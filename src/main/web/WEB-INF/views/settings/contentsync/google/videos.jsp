...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="main-grids">
        ...
        <h4 class="contentTitle">Google Videos</h4>
        ...
        <c:forEach items="${videos}" var="video">
            <div>
                ...
                <form:form id="videosForm${video.providerID}" cssClass="button videosForm" action="/settings/contentsync/google/videos/store" method="post">

                    <input type="hidden" name="providerID" value="${video.providerID}"/>
    ...
    jQuery(document).ready(function ($) {
        $(function () {
            $('.videosForm').on('submit', function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: '/settings/contentsync/google/videos/store',
                    data: $(this).serialize(),
