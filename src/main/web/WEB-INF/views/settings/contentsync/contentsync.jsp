...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="main-grids">
        <h4 class="contentTitle">Content Sync</h4>
        ...
        <c:if test="${socialConnections == 0}">
            <h4 class="contentTitle">Your account is not synced yet. Synchronized it <a
                    href="/settings/socialsync">here</a>.</h4>
        </c:if>
        <social:connected provider="facebook">
            <div><a href="/settings/contentsync/facebook/photos/menu"><img
                    src="<c:url value="/resources/images/social/facebook/sync_photos.png"/>"/></a></div>
            <div><a href="/settings/contentsync/facebook/videos"><img
                    src="<c:url value="/resources/images/social/facebook/sync_videos.png"/>"/></a></div>
            <div><a href="/settings/contentsync/facebook/family/"><img
                    src="<c:url value="/resources/images/social/facebook/family_members.png"/>"/></a></div>
            <div><a href="/settings/contentsync/facebook/info/"><img
                    src="<c:url value="/resources/images/social/facebook/sync_info.png"/>"/></a></div>
        </social:connected>
        <social:connected provider="google">
            <div><a href="/settings/contentsync/google/photos/"><img
                    src="<c:url value="/resources/images/social/google/sync_photos.png"/>"/></a></div>
            <div><a href="/settings/contentsync/google/videos/"><img
                    src="<c:url value="/resources/images/social/google/sync_videos.png"/>"/></a></div>
            <div><a href="/settings/contentsync/google/documents/"><img
                    src="<c:url value="/resources/images/social/google/sync_documents.png"/>"/></a></div>
        </social:connected>
    </div>
    <!-- footer -->
