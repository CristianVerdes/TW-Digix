...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="main-grids">
        ...
        <div>
            <a href="/settings/contentsync/facebook/photos/albums">
                <img class="socialButton" src="/resources/images/social/facebook/photos_from_albums.png"/>
            </a>
        </div>
        <div>
            <a href="/settings/contentsync/facebook/photos/posts">
                <img class="socialButton" src="/resources/images/social/facebook/photos_from_posts.png"/>
            </a>
        </div>
