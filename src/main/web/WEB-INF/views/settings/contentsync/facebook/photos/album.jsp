...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="main-grids">
        <div class="button"><a href="/settings/contentsync/facebook/photos/albums">Back</a></div>
        <h4 class="contentTitle">Album: ${album.name}</h4>

        <c:if test="${photos.size() == 0}">
            <h3 class="contentText">Your album is empty.</h3>
        </c:if>
        <c:forEach items="${photos}" var="photo">
            <div>
                <img class="photo" src="${photo.source}"/>

                <form:form id="storeForm${photo.source}" cssClass="button storeForm" action="/settings/contentsync/facebook/photos/albums/store" method="post">
    ...
    jQuery(document).ready(function ($) {
        $(function () {
            $('.storeForm').on('submit', function (e) {
                ...
                $.ajax({
                    type: 'post',
                    url: '/settings/contentsync/facebook/photos/albums/store',
                    data: $(this).serialize(),
