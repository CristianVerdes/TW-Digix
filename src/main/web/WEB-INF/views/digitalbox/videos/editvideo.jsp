    ...
    <div class="drop-navigation drop-navigation">
        <ul class="nav nav-sidebar">
            ...
            <ul class="cl-effect-1">
                ...
                <li class="active"><a href="${videosURL}"><span class="glyphicon glyphicon-film" aria-hidden="true"></span>Videos</a>
                </li>
...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="main-grids">
        <div class="button"><a href="/digitalbox/videos?page=${sessionScope.get("currentPage")}">Back</a></div>
        <h4 class="contentTitle center">Edit Video</h4>
        ...
        <div class="edit">
            <form:form cssClass="row" action="/digitalbox/editvideo" method="post" modelAttribute="content">
