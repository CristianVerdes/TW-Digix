...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="main-grids">
        <div class="button"><a href="/digitalbox/photos?page=${sessionScope.get("currentPage")}">Back</a></div>
        <h4 class="contentTitle center">Edit Photo</h4>
        ...
        <div class="edit">
            <form:form cssClass="row" action="/digitalbox/editPhoto" method="post" modelAttribute="content">
