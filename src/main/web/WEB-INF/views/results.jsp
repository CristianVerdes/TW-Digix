...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <div class="main-grids">
        <h4 class="contentTitle">Search results</h4>
    </div>
    ...
    <c:if test="${contentList == null}">
        <div class="contentText">No results found <a href="/settings/contentsync">here</a></div>
    </c:if>
    <div class="row">
                    ...
                    <div class="card medium  grey darken-3">
                        ...
                        <div class="card-content grey darken-3">
                            <a href="/profile/userdetails?userID=${content.user.userID}"><span
                                    class="card-title activator white-text">${content.user.firstName} ${content.user.lastName}<i
                                    class="material-icons right">more_vert</i></span></a>
